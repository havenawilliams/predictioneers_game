...
Model.status_quo
average_utility_a
sqrt(1 - average_utility_a)

player_a
player_b

Model.status_quo + sqrt(1 - average_utility_a) / 2
Model.status_quo - sqrt(1 - average_utility_b) / 2

player_a.new_position
player_b.new_position

#Test update_game functions
...
1 - (player_a.position - Model.status_quo) ** 2
