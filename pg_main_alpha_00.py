...
for number in range(0, 10):
    ...
    round_recorder[round_number] = {}

    #Populate round values with a nested dictionary
    for player in players:
        round_recorder[round_number][player.name] = player.utility(Model.status_quo)
    ...
    #Check end game rule
    if check_utility_decreasing(round_number, round_recorder) == True:
